...
import { LeadDetails } from "@/modules/leads/components/lead-details";
...
export default function LeadDetailsPage() {
  ...
  const backHref = selectedCompanyId ? `/leads?company_id=${encodeURIComponent(selectedCompanyId)}` : "/leads";
    ...
    <div className="space-y-6">
      <Card>
        <CardHeader>
          ...
          <CardDescription>Visualize mensagens e enriquecimentos (áudio/imagem).</CardDescription>
        </CardHeader>
      ...
      {selectedCompanyId && leadId ? <LeadDetails companyId={selectedCompanyId} leadId={leadId} /> : null}
    </div>
  );
}
