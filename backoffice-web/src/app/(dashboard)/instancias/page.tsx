...
import { InstancesList } from "@/modules/instancias/components/instances-list";
    ...
    <div className="space-y-6">
      <Card>
        <CardHeader>
          ...
          <CardDescription>Gerencie conexões de canais (WhatsApp) por empresa.</CardDescription>
        </CardHeader>
      ...
      {selectedCompanyId ? <InstancesList companyId={selectedCompanyId} /> : null}
    </div>
  );
}
