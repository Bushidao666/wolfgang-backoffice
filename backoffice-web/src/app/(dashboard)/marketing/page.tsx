...
import { EventsLog } from "@/modules/marketing/components/events-log";
import { PixelsConfig } from "@/modules/marketing/components/pixels-config";
    ...
    <div className="space-y-6">
      <Card>
        <CardHeader>
          ...
          <CardDescription>Pixels e eventos (Facebook CAPI).</CardDescription>
        </CardHeader>
      ...
      {selectedCompanyId ? (
        <div className="grid gap-6 lg:grid-cols-2">
          <PixelsConfig companyId={selectedCompanyId} />
          <EventsLog companyId={selectedCompanyId} />
        </div>
      ) : null}
    </div>
  );
