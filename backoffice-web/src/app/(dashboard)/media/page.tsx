...
import { MediaAssets } from "@/modules/media/components/media-assets";
    ...
    <div className="space-y-6">
      <Card>
        <CardHeader>
          ...
          <CardDescription>Media Tools: biblioteca de assets para envio via Centurions.</CardDescription>
        </CardHeader>
      ...
      {selectedCompanyId ? <MediaAssets companyId={selectedCompanyId} /> : null}
    </div>
  );
}
