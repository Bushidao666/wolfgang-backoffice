...
import { KbManager } from "@/modules/knowledge-base/components/kb-manager";
    ...
    <div className="space-y-6">
      <Card>
        <CardHeader>
          ...
          <CardDescription>Gerencie documentos por empresa para respostas mais precisas.</CardDescription>
        </CardHeader>
      ...
      {selectedCompanyId ? <KbManager companyId={selectedCompanyId} /> : null}
    </div>
  );
}
