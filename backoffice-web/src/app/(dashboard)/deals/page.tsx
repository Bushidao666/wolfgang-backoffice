...
import { DealsList } from "@/modules/deals/components/deals-list";
    ...
    <div className="space-y-6">
      <Card>
        <CardHeader>
          ...
          <CardDescription>Pipeline da empresa (schema tenant).</CardDescription>
        </CardHeader>
      ...
      {selectedCompanyId ? <DealsList companyId={selectedCompanyId} /> : null}
    </div>
  );
}
