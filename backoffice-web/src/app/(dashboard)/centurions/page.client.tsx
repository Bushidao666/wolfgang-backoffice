...
import { CenturionsList } from "@/modules/centurions/components/centurions-list";
...
export default function CenturionsPageClient() {
    ...
    <div className="space-y-6">
      <Card>
        <CardHeader>
          ...
          <CardDescription>Crie, ajuste e teste bots por empresa.</CardDescription>
        </CardHeader>
      ...
      {selectedCompanyId ? <CenturionsList companyId={selectedCompanyId} /> : null}
    </div>
  );
}
